...
class Routine {
  ...
  factory Routine.fromJson(Map<String, dynamic> json) {
    try {
      ...
      final String difficulty =
          json['difficulty']?.toString() ?? 'intermédiaire';
      ...
      try {
        if (json['estimated_duration_minutes'] != null) {
          estimatedDurationMinutes =
              int.tryParse(json['estimated_duration_minutes'].toString()) ?? 30;
        }
      } catch (e) {
      ...
      if (json['exercise_ids'] != null) {
        if (json['exercise_ids'] is List) {
          ...
          debugPrint(
            'WARNING: exercise_ids n\'est pas une liste: ${json['exercise_ids']}',
          );
        }
      }
      ...
      if (json['exercise_details'] != null) {
        try {
          ...
          debugPrint(
            'Erreur lors de la conversion des détails d\'exercice: $e',
          );
        }
      }
      ...
      try {
        ...
        debugPrint(
          'WARNING: Format de date incorrect pour created_at: ${json['created_at']}',
        );
